...
const FILE_TOPIC_MAP: Array<{
  ...
  imagesOnly?: boolean;
    ...
    { file: '../exam-scraper/extractor/jee_sets_and_relations_1.json',
      topic_name: 'Sets and Relations', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_functions_1.json',
      topic_name: 'Functions', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_functions_2.json',
      topic_name: 'Functions', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_complex_numbers_1.json',
      topic_name: 'Complex Numbers', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_complex_numbers_2.json',
      topic_name: 'Complex Numbers', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_quadratic_equation_and_inequalities_1.json',
      topic_name: 'Quadratic Equation and Inequalities', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_quadratic_equation_and_inequalities_2.json',
      topic_name: 'Quadratic Equation and Inequalities', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_permutations_and_combinations_1.json',
      topic_name: 'Permutations and Combinations', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
    { file: '../exam-scraper/extractor/jee_permutations_and_combinations_2.json',
      topic_name: 'Permutations and Combinations', exam_type: 'JEE_MAIN', branch: 'Common', subject: 'Mathematics' },
  ];
