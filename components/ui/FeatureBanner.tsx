...
interface Props {
  heading: string;
  practiceHref: string;
  /** Overrides the default sign-in label on the secondary button */
  signupLabel?: string;
}

export default function FeatureBanner({ heading, practiceHref, signupLabel = "Sign in free →" }: Props) {
  return (
    <section
    ...
    >
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex-1 min-w-[240px]">
          ...
          <h2 className="text-lg md:text-xl font-black mb-2" style={{ color: "var(--text-primary)" }}>
            {heading}
          </h2>
          <ul
