  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-black text-gray-900 dark:text-white">Flagged Questions</h1>
          <p className="text-gray-500 font-medium">Review issues reported by the community.</p>
        </div>
      </div>
